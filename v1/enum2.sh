...
then
    ...
    sudo masscan -p1-65535 -iL ip_addresses --max-rate=1500 --open -oG masscan-all-ports
fi
...
#nmap on masscan output
#echo '[*]Starting nmap'
#mkdir nmap
#massnmap.py masscan-all-ports
#ls nmap/ | xargs -n1 -I{} sh -c "cat nmap/{};echo'';echo'';echo''" >> nmap-all
#rm -rf nmap/
